...
from api.models import Job, LabManagerTracker, get_task, CloudInitFile
...
def resource_cidata(request, lab_name="", job_id="", resource_id=""):
    ...
    cifile = None
    try:
        cifile = CloudInitFile.objects.get(booking__id=job.booking.id, resource_id=resource_id)
