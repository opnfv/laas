...
class ManagerForm(forms.Form):
    step = forms.TextField(widget=forms.widgets.HiddenInput, validators=[validate_step])
    step_form = forms.TextField(widget=forms.widgets.HiddenInput, validators=[validate_step_form])
    # other fields?
