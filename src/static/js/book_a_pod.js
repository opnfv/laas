...
class Booking_Workflow {
    ...
    get_user_templates() {
        ...
        custom.host_list = [new Host('laas-node', 'Gigabyte Arm', 'Ubuntu'), new Host('laas-node-2', 'HPE x86 25G', 'Fedora'), new Host('laas-node-4', 'HPE x86 25G', 'Fedora'), new Host('laas-node-5', 'HPE x86 25G', 'Fedora'), new Host('laas-node-6', 'HPE x86 25G', 'Fedora'), new Host('laas-node-7', 'HPE x86 25G', 'Fedora'), new Host('laas-node-8', 'HPE x86 25G', 'Fedora'), new Host('laas-node-3', 'HPE x86 25G', 'Fedora')];
    ...
    cloud_init_display_cards() {
        for (let i in this.selected_template.host_list) {
            ...
            <div class="card">
                ...
                <input class="p-5" placeholder="Cloud init config...">
            </div>
            `
            document.getElementById("cloud_init_deck").appendChild(new_card);
        }
    }
    ...
    booking_summary_update_text(section) {
        ...
        // Thursdays TODO: Implement this and also add onchange to cloud init, booking details and save to work object
        // 
    } 
