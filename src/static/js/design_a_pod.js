  ...
  class Design_Workflow {
    ...
    add_network() {
      ...
      if (network_input.value.includes('_')) {
        network_input.classList.add('invalid_field');
        error_message.innerText = 'Network names cannot contain underscores.';
        return;
      }
    ...
    submit() {
      ...
      // Input validation
      // TODO: clean fields, restrict characters?, char limit?
