...
class NetworkStep {
    ...
    getClosestNetworkCell(to, within) {
        ...
        //let index = Math.floor(Math.random() * ) % child_keys.length;
        let children = Array.from(within.children);
        let index = Math.floor(children.length * Math.random());
        ...
        console.log(child);
        console.log("Key:");
        console.log(child_keys[index]);
        console.log("Child_keys:");
        console.log(child_keys);
        console.log("Index:");
        console.log(index);
        ...
        console.log(within.children);
        console.log("Within is:");
        console.log(within);
        for (const child_id in within.children) {
            ...
            console.log("Compare children: " + candidate_y + ", " + current_y + " to " + to);

            if( Math.abs(candidate_y * candidate_child.geometry.height - to) < Math.abs(current_y * current_child.geometry.height - to) ) {
    ...
    colorEdge(edge, terminal, source) {
        if(terminal.getParent().getId().indexOf('network') >= 0) {
            ...
            console.log("Colored: " + edge + ", " + terminal + ", " + source);
            console.log(edge);
